...
def initialize_system():
    ...
    # Проверяем наличие API ключа ProxyAPI или OpenAI
    api_key = os.getenv("PROXY_API_KEY") or os.getenv("OPENAI_API_KEY")
    if not api_key:
        print("⚠️  ВНИМАНИЕ: Не найден PROXY_API_KEY или OPENAI_API_KEY в переменных окружения!")
        print("   Создайте файл .env и добавьте туда: PROXY_API_KEY=your_key_here")
